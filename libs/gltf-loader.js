// libs/gltf-loader.js — 微信官方 GLTFLoader 适配层（微信小游戏环境，r108 兼容）
// 来源: wechat-miniprogram/miniprogram-demo (packageAPI/pages/ar/loaders/gltf-loader.js), MIT License
// https://github.com/wechat-miniprogram/miniprogram-demo
// 改动: 仅将 ESM `export function` 转为 CommonJS 导出，函数体保持官方原样。
// 注: 文件内 wx.arrayBufferToBase64 仅在解析含 bufferView 纹理的 GLB 时运行期调用，require 阶段不触 wx。
